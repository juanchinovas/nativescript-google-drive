...
declare class GTMGatherInputStream extends NSInputStream implements NSStreamDelegate {
	...
	static streamWithArray(dataArray: NSArray<any> | any[]): NSInputStream;
...
declare class GTMMIMEDocument extends NSObject {
	...
	static findBytesWithNeedleNeedleLengthHaystackHaystackLengthFoundOffset(needle: string | interop.Pointer | interop.Reference<any>, needleLength: number, haystack: string | interop.Pointer | interop.Reference<any>, haystackLength: number, foundOffset: interop.Pointer | interop.Reference<number>): number;
...
declare class GTMSessionCookieStorage extends NSHTTPCookieStorage {
	...
	setCookies(cookies: NSArray<NSHTTPCookie> | NSHTTPCookie[]): void;
}
...
declare class GTMSessionFetcherService extends NSObject implements GTMSessionFetcherServiceProtocol {
	...
	static mockFetcherServiceWithFakedDataFakedResponseFakedError(fakedDataOrNil: NSData, fakedResponse: NSHTTPURLResponse, fakedErrorOrNil: NSError): GTMSessionFetcherService;
...
declare class GTMSessionSyncMonitorInternal extends NSObject {
	...
	constructor(o: { synchronizationObject: any; allowRecursive: boolean; functionName: string | interop.Pointer | interop.Reference<any>; });

	initWithSynchronizationObjectAllowRecursiveFunctionName(object: any, allowRecursive: boolean, functionName: string | interop.Pointer | interop.Reference<any>): this;
}
...
declare class GTMSessionUploadFetcher extends GTMSessionFetcher {
	...
	static uploadFetcherWithLocationUploadMIMETypeChunkSizeAllowsCellularAccessFetcherService(uploadLocationURL: NSURL, uploadMIMEType: string, chunkSize: number, allowsCellularAccess: boolean, fetcherServiceOrNil: GTMSessionFetcherService): GTMSessionUploadFetcher;
	...
	cancellationHandler: (p1: GTMSessionFetcher, p2: NSData, p3: NSError) => void;
...
declare var kGTMSessionFetcherStatusDataContentTypeKey: string;
